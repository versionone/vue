...
import Portal from '@versionone/ui-portal';
import React, {Component, PropTypes} from 'react';
import ThemeProvider from '@versionone/ui-theme-provider';
import throttle from 'lodash.throttle';
import {CustomPropTypes, dom, position, positionAlignments, Radium} from '@versionone/ui-utilities';
...
class Popover extends Component {
    ...
    static defaultProps = {
        anchorOrigin: {
            horizontal: positionAlignments.left,
            vertical: positionAlignments.bottom,
        },
        ...
        targetOrigin: {
            horizontal: positionAlignments.left,
            vertical: positionAlignments.top,
        },
    };
    static contextTypes = {
